...
AS 'price_eval'
FROM `Facilities` ORDER BY `membercost` ASC 

/* Q6: You'd like to get the first and last name of the last member(s)
who signed up. Try not to use the LIMIT clause for your solution. */

SELECT surname, firstname, joindate, MAX(joindate) AS Max_Date
FROM `Members`;
...
FROM Members AS m
    ...
    INNER JOIN Facilities AS f
    	ON b.facid = f.facid
WHERE name = 'Tennis Court' OR name = 'Tennis Court 1' OR name = 'Tennis Court 2';
